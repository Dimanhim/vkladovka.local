    ...
    <div class="thing-actions">
        <table class="table">
            <form action="">
                ...
                <tr>
                    <td>
                        Нужны грузчики <input type="checkbox" name="3" />
                    </td>
                    <td class="bold">
                ...
                <tr>
                    ...
                    <td>
                        <!-- Поменять на button -->
                        <a href="<?= Yii::$app->urlManager->createUrl(['lk/manager-message', 'id' => $id]) ?>" class="btn btn-primary" name="order">Заказать грузоперевозку</a>
                    </td>
                </tr>
            </form>
        </table>
