...
<div class="container page-two">
    ...
    <div class="sub-info-for">
        ...
        <ul>
            <li><a href="/site/legal-notice">Пользовательское соглашение</a></li>
            <li><a href="#" class="quest" onclick="alert('В процессе формирования'); return false;">Договор хранения</a></li>
        ...
        <form action="" class="order form-main">
            ...
            <div class="check-form">
                <label for="n51"><input type="checkbox" id="n51" class="form-control" checked> Ознакомлен и согласен с <a href="/site/legal-notice">пользовательским соглашением</a></label>
            </div>
            <div class="check-form">
