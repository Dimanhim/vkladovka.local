...
<ul class="bread-crumps">
    ...
    <li> / Прочие расходники </li>
</ul>
<!-- Хлебные крошки -->

<div class="col-md-12">
    <h2 class="tac">Выбрать расходники</h2>
</div>
        ...
        <div class="row">
            <?php for($i = 1; $i < 9; $i++) { ?>
                <div class="col-md-4 col-sm-4 col-xs-4">
                    <div class="cat-item">
                        <div class="cat-img">
                            <a href="/img/package-3.jpg" class="gallery">
                                <img src="/img/package-3.jpg" alt="">
                            </a>
                            <a href="<?= Yii::$app->urlManager->createUrl(['lk/package/item']) ?>">Пластиковый пакет</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
